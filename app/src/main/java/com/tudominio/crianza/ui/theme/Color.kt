...
val BgGrad5 = Brush.verticalGradient(listOf(Color(0xFF075985), Color(0xFF38BDF8))) // azul cielo (Mensajes)
val BgGrad6 = Brush.verticalGradient(listOf(Color(0xFF9A3412), Color(0xFFFB923C))) // naranja (Recuerdos)
val BgGrad7 = Brush.verticalGradient(listOf(Color(0xFF4C1D95), Color(0xFFA855F7))) // violeta (Documentos)
...
val CardGrad5 = Brush.linearGradient(listOf(Color(0xFF075985), Color(0xFF38BDF8))) // azul cielo (Mensajes)
val CardGrad6 = Brush.linearGradient(listOf(Color(0xFF9A3412), Color(0xFFFB923C))) // naranja (Recuerdos)
val CardGrad7 = Brush.linearGradient(listOf(Color(0xFF4C1D95), Color(0xFFA855F7))) // violeta (Documentos)
